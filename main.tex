...
\hspace{1cm}Lớp: \dotfill Tên nhóm: \dotfill HK \dotfill Năm học \dotfill
...
\begin{tabularx}{\linewidth}{|c|c|X|X|X|c|c|c|}
    \hline
    \textbf{STT} & \textbf{Mã số HV} & \textbf{Họ} & \textbf{Tên} & \textbf{Nhiệm vụ được phân công} & \textbf{Nhóm đánh giá} & \textbf{Điểm (GV chấm)} & \textbf{Ký tên (Học viên)} \\
    \hline
    1 & & & & & & & \\
    \hline
    2 & & & & & & & \\
...
Họ và tên nhóm trưởng:\dotfill, Số ĐT: \dotfill Email: \dotfill
...
Lớp: \dotfill \hspace{2cm} Nhóm: \dotfill \hspace{2cm} Học kỳ \dotfill

\vspace{0.3cm}

Nhóm trưởng: \dotfill Số di động \dotfill Email\dotfill
...
\begin{tabularx}{\linewidth}{|c|c|X|X|c|c|c|c|}
    \hline
    \textbf{Stt} & \textbf{ID} & \textbf{Họ và lót} & \textbf{Tên} & \textbf{Bài tập quá trình trên BK\_LMS (5,0 đ)} & \textbf{Xây dựng bài, Chuyên cần (5,0đ)} & \textbf{Tổng Khác 20\%} & \textbf{Ký tên} \\
