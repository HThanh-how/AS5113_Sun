...
\begin{titlepage}
    ...
    % Decorative symbol
    {\color{bkblue} $\infty \cdots \diamond \cdots \infty$}
...
\hspace{1cm}Lớp: \underline{\hspace{1cm}CH03\hspace{1cm}} Tên nhóm: \underline{\hspace{1cm}Nhóm 7\hspace{1cm}} HK: \underline{\hspace{0.5cm}252\hspace{0.5cm}} Năm học: \underline{\hspace{1cm}2025-2026\hspace{1cm}}
}

\vspace{0.3cm}

{\fontsize{11}{13}\selectfont 
Đề tài: \underline{\hspace{0.3cm}Lịch sử triết học phương Tây: Chủ nghĩa khắc kỉ và vai trò của nó đối với đời sống xã hội\hspace{0.3cm}}
}
...
\begin{tabular}{|c|c|p{2cm}|p{2cm}|p{4.5cm}|c|c|c|}
    \hline
    \textbf{STT} & \textbf{Mã số HV} & \textbf{Họ} & \textbf{Tên} & \textbf{Nhiệm vụ được phân công} & \textbf{Nhóm} & \textbf{Điểm} & \textbf{Ký tên} \\
    & & & & & \textbf{đánh giá} & \textbf{(GV} & \textbf{(Học} \\
    & & & & & & \textbf{chấm)} & \textbf{viên)} \\
    \hline
...
\begin{tabular}{p{7cm} p{7cm}}
    \centering \textbf{GIẢNG VIÊN} & \centering \textbf{NHÓM TRƯỞNG} \\
    \centering \textit{(Ký và ghi rõ họ, tên)} & \centering \textit{(Ký và ghi rõ họ, tên)} \\
    & \\
    & \\
    \centering TS. Nguyễn Thị Minh Hương & \centering Nguyễn Thế Dân \\
\end{tabular}
\end{center}
